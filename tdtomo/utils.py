...
from tomobase.registers import logger, proxy, GPUContext, image_datatypes_register
...
def _buildmodelswidget(viewer: 'napari.viewer.Viewer'):
    """Build the models widget for the viewer.
    Args:
        viewer (napari.viewer.Viewer): The napari viewer instance.
    """
    pass
